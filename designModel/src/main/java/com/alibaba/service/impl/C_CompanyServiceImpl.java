...
import com.alibaba.enums.C_MemberEnum;
import com.alibaba.enums.CompanyEnum;
import com.alibaba.service.DisCountService;

import java.util.Objects;

public class C_CompanyServiceImpl implements DisCountService {
    ...
    public double calcPrice(ItemEntity itemEntity, MemberEntity memberEntity) {
        ...
        if(!CompanyEnum.C.equals(memberEntity.getCompany())) {
        ...
        return itemEntity.getPrice() * C_MemberEnum.getDiscount(memberEntity.getMemberLevel());
    }
}
