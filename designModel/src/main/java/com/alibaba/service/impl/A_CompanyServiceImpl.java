...
public class A_CompanyServiceImpl implements DisCountService {
    ...
    public double calcPrice(ItemEntity itemEntity, MemberEntity memberEntity) {
        ...
        if(!CompanyEnum.A.equals(memberEntity.getCompany())) {
        ...
        return itemEntity.getPrice() * A_MemberEnum.getDiscount(memberEntity.getMemberLevel());
    }
}
