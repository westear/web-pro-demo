...
public class $ProxyHandler implements DemoDao{
	...
	public void query(String param1,Integer param2) {
		try {
			Method method = Class.forName("demo.aop.dao.DemoDao").getDeclaredMethod("query",new Class[]{String.class,Integer.class});
	...
	public void query(String param1) {
		try {
			Method method = Class.forName("demo.aop.dao.DemoDao").getDeclaredMethod("query",new Class[]{String.class});
	...
	public String getSql(String param1) {
		try {
			Method method = Class.forName("demo.aop.dao.DemoDao").getDeclaredMethod("getSql",new Class[]{String.class});
