...
import demo.aop.proxy.JdkProxyGeneratorTest;
...
public class AspectDemo {
     ...
     */
    @Pointcut("this(demo.aop.dao.DemoDaoImpl)")
    public void thisPointCut(){};

    /**
     * 目标对象永远不变，与 proxyTargetClass=true|false 无关
     */
    @Pointcut("target(demo.aop.dao.DemoDaoImpl)")
    public void targetPointCut(){}

    @Pointcut("@annotation(demo.aop.anno.Checkout)")
