...
public class JdkDynamicProxyUtil {
    ...
    public static Object generateProxyClass(Class target, MyInvocationHandler handler) {
        ...
        String content;
        String packageContent = "package com.spring.demo.aop.proxy;" + LINE;
        String importContent = "import " + target.getName() + ";" + LINE
                                + "import com.spring.demo.aop.handler.MyInvocationHandler;" + LINE
        ...
        File file =new File("D:\\IdeaProjects\\mmall_learning\\src\\main\\java\\com\\spring\\demo\\aop\\proxy\\$ProxyHandler.java");
        try {
            if(!file.isDirectory()) {
            ...
            URL[] urls = new URL[]{new URL("file:D:\\\\IdeaProjects\\\\mmall_learning\\\\src\\\\main\\\\java\\\\")};
            URLClassLoader urlClassLoader = new URLClassLoader(urls);
            Class clazz = urlClassLoader.loadClass("com.spring.demo.aop.proxy.$ProxyHandler");
