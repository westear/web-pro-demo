 ...
 * 注意：在handleHttpRequest中对每个channel连接的时候对每个连接的url进行绑定参数，
 ...
 *
 * @author Qinyunchan
 * @date Created in 4:50 PM 2018/11/23
 * @Modified By
 */
...
public class MyWebSocketServerHandler extends SimpleChannelInboundHandler<Object> {
    ...
    private void handlerWebSocketFrame(ChannelHandlerContext ctx, WebSocketFrame frame) {
        ...
        TextWebSocketFrame tws = new TextWebSocketFrame(new Date().toString() + ctx.channel().remoteAddress() + "：" + request);
        // 群发
